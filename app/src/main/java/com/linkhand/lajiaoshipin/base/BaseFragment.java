...
import com.linkhand.lajiaoshipin.widget.LoadingPopup;

import org.greenrobot.eventbus.EventBus;

import java.util.List;

import static com.linkhand.lajiaoshipin.base.BaseAppCompatActivity.NON_CODE;
...
public class BaseFragment extends Fragment {
    ...
    private Runnable mLoadingRunnable = new Runnable() {
        ...
        public void run() {
            if (loadingPop == null) {
                if (getActivity() != null) {/*由于在小米市场上传的时候出现了getActivity为空(故此判断--如下51行也是)*/
    ...
    public void initRefreshGridView(PullToRefreshGridView mListview) {
        ILoadingLayout startLables = mListview.getLoadingLayoutProxy(true,false);
        startLables.setPullLabel("下拉刷新");
        startLables.setRefreshingLabel("玩命刷新中...");
        startLables.setReleaseLabel("放开刷新");
