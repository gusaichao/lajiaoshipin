...
public class UserHistoryAdapter extends CommonAdapter {
    private Context mContext;
    private List<UserHistory.DataBean> mList;

    public UserHistoryAdapter(Context context, int layoutId, List datas) {
    ...
    protected void convert(ViewHolder viewHolder, Object item, final int position) {
        ...
        textname.setText(mList.get(position).getPost_title());
