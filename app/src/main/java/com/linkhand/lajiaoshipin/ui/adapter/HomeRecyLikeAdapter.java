...
public class HomeRecyLikeAdapter extends RecyclerView.Adapter<HomeRecyLikeAdapter.MyVh> {
    private Context context;
    private List<HomeBean.DataBean.LikeBean> list;

    public HomeRecyLikeAdapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<HomeBean.DataBean.LikeBean> list) {
        this.list = list;
    }
