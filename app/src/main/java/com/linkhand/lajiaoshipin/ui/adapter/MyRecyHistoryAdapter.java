...
public class MyRecyHistoryAdapter extends RecyclerView.Adapter<MyRecyHistoryAdapter.MyVh> {
    private Context context;
    private List<UserHistory.DataBean> list;

    public MyRecyHistoryAdapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<UserHistory.DataBean> list) {
        this.list = list;
    }
