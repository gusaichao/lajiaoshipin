...
public class VideoGuanggaoRecyAdapter extends RecyclerView.Adapter<VideoGuanggaoRecyAdapter.MyVh> {
    private Context context;
    private List<MovieindexBean.DataBean.AdvBean> list;

    public VideoGuanggaoRecyAdapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<MovieindexBean.DataBean.AdvBean> list) {
        this.list = list;
    }
