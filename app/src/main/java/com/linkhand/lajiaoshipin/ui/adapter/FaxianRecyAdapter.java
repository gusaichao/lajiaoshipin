...
public class FaxianRecyAdapter extends RecyclerView.Adapter<FaxianRecyAdapter.MyVh> {
    private Context context;
    private List<FindvideoBean.DataBean> list;

    public FaxianRecyAdapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<FindvideoBean.DataBean> list) {
        this.list = list;
    }
